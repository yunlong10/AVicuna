...
class AVicunaLlamaModel(LlamaModel, AVicunaMetaModel):
    ...
    def __init__(self, config: LlamaConfig):
        super(AVicunaLlamaModel, self).__init__(config)

class AVicunaLlamaForCausalLM(LlamaForCausalLM, AVicunaMetaForCausalLM):
    config_class = AVicunaConfig

    def __init__(self, config):
        super(LlamaForCausalLM, self).__init__(config)
        self.model = AVicunaLlamaModel(config)
...
AutoConfig.register("AVicuna", AVicunaConfig)
AutoModelForCausalLM.register(AVicunaConfig, AVicunaLlamaForCausalLM)
